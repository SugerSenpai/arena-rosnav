import rospy
from task_generator.shared import DynamicObstacle, Namespace, Obstacle, PositionOrientation, Robot, WorldWalls
...
class EntityManager:
    ...
    def spawn_line_obstacles(self, walls: WorldWalls):
        """
        Creates walls.
        """
        raise NotImplementedError()
